...
"$EMSCRIPTEN/em++" \
  ...
  -Isrc/ \
  -s "$BINARYEN_JS_EXPORTS" \
  -o bin/binaryen.wasm${OUT_FILE_SUFFIX}.js \
  --pre-js src/js/binaryen.js-pre.js \
  --post-js src/js/binaryen.js-post.js
